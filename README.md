...
| **PWDTT** | Desktop Win/Linux | `wdtt://` (colon), до 4 хешей через `,` или `VK_HASH` — **[pwdtt-client](https://github.com/ildarmaga/pwdtt-client/releases/latest)** |
...
| [ildarmaga/pwdtt-client](https://github.com/ildarmaga/pwdtt-client) | **PWDTT Client** — рекомендуемый клиент Windows/Linux (в [релизах WDTT](https://github.com/ildarmaga/wdtt/releases/latest) — `pwdtt-client-*`) |
